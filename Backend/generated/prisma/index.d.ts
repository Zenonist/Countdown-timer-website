...
export namespace Prisma {
  ...
  */
  ...
  export type TimerOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "title" | "description" | "dueDate" | "category" | "isArchived", ExtArgs["result"]["timer"]>
  ...
  interface TimerFieldRefs {
    ...
    readonly category: FieldRef<"Timer", 'String'>
  ...
  export type TimerWhereInput = {
    ...
    category?: StringFilter<"Timer"> | string
  ...
  export type TimerScalarWhereWithAggregatesInput = {
    ...
    category?: StringWithAggregatesFilter<"Timer"> | string
